...
const jogos = [
  ...
  },
  {
    ...
    nome: "Ale E Tale",
    description:
      "Ale e Tale é um jogo de aventura e exploração, onde os jogadores controlam Ale e Tale, dois personagens com habilidades diferentes, enquanto desvendam mistérios em um mundo mágico. A trama envolve resolver quebra-cabeças, enfrentar inimigos e tomar decisões que afetam a história.",
    video: "",
  },
  {
    id: "3",
  ...
  {
    id: "5",
    nome: "Buckyshot Roulette",
    description:
      "Buckyshot Roulette é um jogo de ação com elementos de roguelike, onde os jogadores enfrentam desafios imprevisíveis a cada rodada, combinando sorte e estratégia. O objetivo é sobreviver o máximo possível em uma roleta cheia de riscos e inimigos.",
    video: "",
  },
  {
    id: "2",
