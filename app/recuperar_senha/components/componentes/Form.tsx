...
export const Form = ({
  ...
  return (
    <div className="mt-12 flex h-full w-full flex-col bg-black">
        ...
        <div className="min-h-[calc(100vh-64px)] bg-gradient-to-b from-[#02030a] to-[#0E304A]">
          <div className="container mx-auto flex items-center justify-center px-6 py-16">
            <div className="flex w-full max-w-5xl overflow-hidden rounded-2xl shadow-2xl">
              ...
              <div className="flex w-full flex-col justify-center bg-[#020913] md:p-12 lg:w-1/2">
                <div className="mb-8 text-center">
                  ...
                  <form className="mt-2 space-y-6" onSubmit={onsubmit}>
                    <div>
                      <label className="mb-2 flex items-center justify-between text-sm font-medium text-[#F6F7F8]">
                        Email
                      </label>
                      <input
                        type="email"
                    ...
                    <div>
                      <input
                        type="submit"
                        src="/recuperar_senha"
                        className="w-full cursor-pointer rounded-br-3xl rounded-tl-3xl bg-[#019EC2] py-3 text-lg font-bold text-[#F6F7F8] transition-colors hover:bg-[#198097]"
