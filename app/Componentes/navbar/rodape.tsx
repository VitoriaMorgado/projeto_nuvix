        ...
        <div className="grid gap-10 md:grid-cols-3">
          ...
          <div className="flex flex-col items-center md:items-start">
            ...
            <div className="flex space-x-4">
              <a
                href="#"
                className="group rounded-full bg-gray-800 p-2 transition-transform hover:scale-110 hover:bg-blue-600"
              >
                <svg
              ...
              <a
                href="#"
                className="group rounded-full bg-gray-800 p-2 transition-transform hover:scale-110 hover:bg-blue-400"
              >
                <svg
                  className="h-5 w-5 text-gray-300 group-hover:text-white"
                  fill="currentColor"
