          ...
          <div className="flex flex-col md:flex-row md:items-center md:justify-between">
            <div className="mb-4 flex items-center md:mb-0">
              ...
              <nav className="ml-8 hidden md:flex">
                ...
                <Link
                  href="#"
                  className="border-b-2 border-blue-500 px-3 py-2 text-gray-300 hover:text-white"
                >
                  Jogos
                </Link>
                <Link
            ...
            <div className="flex items-center space-x-4">
              ...
              <button className="rounded-lg border border-gray-600 bg-transparent px-4 py-2 text-white transition-colors duration-200 hover:bg-gray-700">
                Cadastrar
              </button>
            </div>
          </div>
