...
import { Menu, X, User, Bell, Search, LogOut, Settings, MessageSquare} from 'lucide-react';
        ...
        <div className="flex items-center justify-between h-14">
          ...
          <div className="flex items-center space-x-2">
            <div className="relative group">
              <h1 className="text-2xl font-bold bg-clip-text text-transparent bg-gradient-to-r from-[#F6F7F8] to-[#019EC2] hover:from-[#019EC2] hover:to-[#198097] transition-all duration-300 cursor-pointer">
                Nuvix
              </h1>
